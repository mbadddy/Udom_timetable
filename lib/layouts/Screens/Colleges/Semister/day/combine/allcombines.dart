              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Center(
                        child: Text(
                      "Are You Sure You Want To Delete All Combines",
  ...
  void clearCombines() {
    if (colleges != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("All Combines Deleted"),
        width: 280.0,
        behavior: SnackBarBehavior.floating,
      ));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          venyus == null || venyus!.isEmpty
              ? Center(
                  child: Text("No Previews Yet"),
                )
              : Description2(),
          Expanded(
              flex: 1,
