...
void dialog(String day,String programe,String coll,String sem,String year)async{
                        ...
                        dropdownHeight: 220,
                         ...
                         if(collegess![x]==widget.college && progssss![x]==widget.programme
                          ...
                          && cozessss![x]==course.value){
                            ...
                            if(time_f.value==null || course.value==null || time_t.value==null || venue.value==null){
  ...
  // data=[,,,,,course.value!,time.value!,lecture.value!];
                           ...
                           if(combinebox!.get('instructors')==null){
                                   ...
                                   List<String>? instructs=combinebox!.get('instructors');
                                      instructorss.add(instructorrr!);
                                 ...
                                 if(combinebox!.get('programmes')==null){
                                   ...
                                   List<String>? programes=combinebox!.get('programmes');
                                      programmes.add(programe);
                             ...
                             ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Combine Saved Successfully"))); 
...
String venue,String time_to,String day){
              ...
              Text("College: ${coll}"),
               ...
               Row(
                ...
                combinebox!.put('courses', cozes);
                 ...
                 ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Combine Deleted Successfully"))); 
                  }
                  else{
