                      ...
                      Positioned(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(color: appbarc, width: 10)),
                          child: const Center(
                            child: ClipOval(child: Text("hello")),
                          ),
                        ),
                      ),
                      Positioned(
...
//axams
  ...
  Widget build(BuildContext context) {
    ...
    print(
        'today is ${DateFormat.EEEE().format(date)} time ${DateFormat.Hm().format(date)}..........................');
    if (combine == true) {
      setState(() {
